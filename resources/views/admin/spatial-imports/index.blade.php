...
<div class="space-y-8">
    ...
    <section class="space-y-4">
        ...
        @forelse($imports as $import)
            @php
                $importStatusUrl = $import->dataset && in_array($import->status, [\App\Enums\SpatialImportStatus::ContractDraft, \App\Enums\SpatialImportStatus::Approved], true)
                    ? route('admin.spatial-datasets.index').'#dataset-'.$import->dataset->slug
                    : route('admin.spatial-imports.index').'#import-'.$import->id;
            @endphp
